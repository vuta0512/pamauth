...
public class FunctionalTest extends WithApplication {
    ...
    public void redirectHomePage() {
        Result result = route(app, ApplicationController.index());
    ...
    public void listComputersOnTheFirstPage() {
        Result result = route(app, ApplicationController.list(0, "name", "asc", ""));
    ...
    public void filterComputerByName() {
        Result result = route(app, ApplicationController.list(0, "name", "asc", "Apple"));
    ...
    public void createANewComputer() {
        Result result = route(app, addCSRFToken(fakeRequest().uri(ApplicationController.save().url())));
        assertThat(result.status()).isEqualTo(OK);
        ...
        String saveUrl = ApplicationController.save().url();
        ...
        result = route(app, ApplicationController.list(0, "name", "asc", "FooBar"));
        assertThat(result.status()).isEqualTo(OK);
